...
public sealed class Localizer(IJSRuntime js)
{
    ...
    private static readonly Dictionary<string, string> Bg = new(StringComparer.Ordinal)
    {
        ...
        ["Imported expenses are reviewed in the Spending tab; money-in under Money → Move money."] = "Импортираните разходи се преглеждат в раздел Разходи; приходите — в Пари → Премести пари.",
